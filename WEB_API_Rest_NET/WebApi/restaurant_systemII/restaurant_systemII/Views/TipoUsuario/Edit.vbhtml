...
@Code
    ViewData("Title") = "Actualizar el Tipo de Usuario"
...
<body>
    <div class="container">
        <div class="row mt-3">
            <div class="col">*@
                <h1 style=" text-align:center; text-transform: uppercase ; text-decoration: dotted ;">Modificar el registro:<span class="badge badge-info ml-2"> @Model.pTipoUsuarioID</span> de Tipo Usuario</h1>
                <hr>
