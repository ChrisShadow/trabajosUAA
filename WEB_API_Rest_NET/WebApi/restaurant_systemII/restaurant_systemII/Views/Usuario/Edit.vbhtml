...
<body>
    <div class="container">
        <div class="row mt-3">
            <div class="col">*@
                <h1 style=" text-align:center; text-transform: uppercase ; text-decoration: dotted ;">Modificar el registro: <span class="badge badge-info ml-2">@Model.pUsuarioID</span>  de Usuario </h1>
                <hr>
                <form action="Edit" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-6 mb-3">
                            <!--Id del usuario-->
                            <input type="hidden" name="txtUsuarioID" value="@Model.pUsuarioID" />
                            <label for="txtNombre" class=" my-3 mx-3 ">
                                Nombre:
                            </label><input type="text" class="form-control" name="txtNombre" placeholder="Ingrese el Nombre" maxlength="20" required value=" @Model.pNombre" />
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                            <label for="txtEmail" class=" my-3 mx-3 ">
                                Email:
                            </label><input type="email" class="form-control" name="txtEmail" placeholder="Ingrese la dirección gmail" maxlength="20" required value=" @Model.pEmail" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-12 col-md-6 mb-3">
                            <label for="txtContrasenha" class=" my-3 mx-3 ">
                                Contraseña:
                            </label><input type="password" id="senhauno" class="form-control" name="txtContrasenha" placeholder="Ingrese la Contraseña" maxlength="20" required value=" @Model.pContraseña" />
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <select name="txtTipoUsuarioID" id="" class="form-control">
                                @For Each row In ViewData("TipoUsuario")
                                    @<option value="@row("TipoUsuarioID")" @IIf(Model.pTipoUsuarioID = row("TipoUsuarioID"), "Selected", "")>@row("Descripcion")</option>
                                Next
                            </select>
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <div Class="form-check">
                                <Label for="rdbActivo" class="form-check-label my-3 mx-3 ">
                                    @IIf(Model.pActivo = "s", Html.Raw("<input type='radio' name='rdbActivo' id='rdbActivo' value='s' checked> Sí"), Html.Raw("<input type='radio' name='rdbActivo' id='rdbActivo' value='s' > Sí"))

                                </Label>
                                <Label for="rdbActivo" class="form-check-label my-3  mx-3 ">
                                    @IIf(Model.pActivo = "n", Html.Raw("<input type='radio' name='rdbActivo' id='rdbActivo' value='n' checked> No"), Html.Raw("<input type='radio' name='rdbActivo' id='rdbActivo' value='n'> No"))
                                </Label>
                            </div>
                        </div>
                    </div>
