...
<div class="jumbotron bg-cyan">
    <h3 class="display-1 mb-3 text-center">SISTEMA DE GESTIÓN DE RESTAURANTE</h3>
</div>
<h3><span class="badge badge-pill badge-dark">Welcome!</span></h3>
<p><span class="badge badge-pill badge-light">System homepage</span></p>
@*</div>
        </div>
    </div>*@
