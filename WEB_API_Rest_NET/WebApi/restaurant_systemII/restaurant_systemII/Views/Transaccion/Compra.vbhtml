...
End Code
<h1 style=" text-align:center; text-transform: uppercase ; text-decoration: dotted ;">Listado de Compras</h1>
<hr>
<div class="row justify-content-end">
    <a href="~/Transaccion/NuevaCompra/" class="btn btn-outline-info text-uppercase mb-3  font-weight-bold "><mark>Agregar</mark></a>
</div>
...
<table class="table table-sm table-bordered table-responsive-xl mt-3" id="datatable_plug">
    ...
    <tbody class="text-left">
        @For Each row In ViewData("compras")
