...
@Code
    ViewData("Title") = "Agregar Tipo de Categoría"
...
<body>
    <div class="container">
        <div class="row mt-3">
            <div class="col">*@
                <h1 style=" text-align:center; text-transform: uppercase ; text-decoration: dotted ;">Agregar una nueva categoría</h1>
                <hr>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <div class="form-check">
                                <label for="rbEstado" class="form-check-label my-3 mx-3 ">
                                    <input type="radio" name="rbEstado" id="rbEstado" value="S"> Sí
                                </label>
                                <label for="rbEstado" class="form-check-label my-3 mx-3 ">
                                    <input type="radio" name="rbEstado" id="rbEstado" value="N"> No
                                </label>
                            </div>
                        </div>
                    </div>
