...
@Code
    ViewData("Title") = "Actualizar la Unidad de Medida"
...
<head>
    ...
    <title>Actualizar la Unidad de Medida</title>
...
<body>
    <div class="container">
        <div class="row mt-3">
            <div class="col">*@
                <h1 style=" text-align:center; text-transform: uppercase ; text-decoration: dotted ;">Modificar el registro:<span class="badge badge-info ml-2">@Model.pUnidadMedidaID</span>  de Unidad de Medida</h1>
                <hr>
                <form action="Edit" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-12 col-md-6 mb-3">
                            <input type="hidden" name="txtUnidadMedidaID" value=" @Model.pUnidadMedidaID" />
